...
sudo mv /usr/local/lib/node_modules/hasenpfeffr/src/algos/whitelist_pubkeys.json /usr/local/lib/strfry/plugins/data/whitelist_pubkeys.json
sudo chown hasenpfeffr:hasenpfeffr /usr/local/lib/strfry/plugins/data/whitelist_pubkeys.json
