  ...
  try {
    ...
    let query = `
      ...
      RETURN 
        ...
        u.hops AS hops,
        u.personalizedGrapeRank_influence AS influence,
        u.personalizedGrapeRank_average AS average,
        u.personalizedGrapeRank_confidence AS confidence,
        u.personalizedGrapeRank_input AS input
...
function createEvent(userPubkey, personalizedPageRank, hops, influence, average, confidence, input) {
  ...
  const event = {
    ...
    tags: [
      ['d', userPubkey],
      ['k', '0'],
      ['rank', personalizedPageRank.toString()],
      ['hops', hops.toString()],
