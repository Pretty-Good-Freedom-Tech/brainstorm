...
emit_task_event "TASK_START" "syncWoT" "system" '{
    ...
    "target_relays": ["wot.brainstorm.social"],
...
emit_task_event "PROGRESS" "syncWoT" "system" '{
    ...
    "message": "Starting synchronization with wot.brainstorm.social"
}'
...
emit_task_event "PROGRESS" "syncWoT" "system" '{
    ...
    "relay": "wot.brainstorm.social",
    "message": "Completed synchronization with wot.brainstorm.social"
}'
...
emit_task_event "TASK_END" "syncWoT" "system" '{
    "phases_completed": 2,
    "relays_synced": ["wot.brainstorm.social"],
    "sync_direction": "down",
    "filter_kinds": [3, 1984, 10000, 30000, 38000, 38172, 38173],
    "status": "success",
